...
import { FaAngleUp, FaAngleDown, FaInstagram, FaYoutube } from 'react-icons/fa6'
import {
  FaFacebookSquare,
  FaCcPaypal,
  FaCcVisa,
...
export const products = [
  {
    ...
    specialFeatures:
      'Wireless reverse charging, AR support, under-display fingerprint sensor, etc', // Tính năng đặt biết
    colors: '[black,white]',
  ...
  },
  {
    ...
    description: 'Siếu cấp vip pro',
    image: './S24 Ultra den.png',
    manufacturer: 'SAMSUNG', // hãng sản xuất
    series: 'SamSung Galaxy S series',
    releaseDate: '31/12/2023', // ngày sản xuất
    price: '400000000',
    OS: 'Android', // hệ điều hành,
    screenSize: '5.1 inches', //kích thước màn hình,
    screenType: 'AMOLED', //  loại màn hình
    cpu: 'Exynos', // vi xử lí
    ram: '12GB', //
    rom: '256GB', // bộ nhớ trong
    ...
    dimensions: 'length: 160.7 mm, width: 77.6 mm, thickness: 7.85 mm, ',
    accessoriesIncluded: 'Charging cable, charger, headphones, phone case', // phụ kiện kèm theo
    numberOfReviews: '2k', // tổng số đánh giá
    rating: '4.5/5', // đánh giá
    stockQuantify: '800', // số lượng còn lại
    productCondition: 'New: 400, Used: 200, Refurbished: 200', // tình trạng sản phẩm
    warranty: '12 months', // bảo hành
  },
  {
    _id: '3333',
    ...
    waterResistance: 'IP68', // khả năng chống nước…
    connectivity: ' Wi-FI, Bluetooth, NFC, GPS, USB-C', // Khả năng kết nối
    speakers: 'Dolby Atmos', // Loa
    ports: 'Type C', // Cổng kết nối
    specialFeatures:
      'Wireless reverse charging, AR support, under-display fingerprint sensor, etc', // Tính năng đặt biết
    colors: 'BLue',
    weight: '180g, 220g', // trọng lượng
    ...
    numberOfReviews: ' 1.8k', // tổng số đánh giá
    rating: '4.5/5', // đánh giá
    stockQuantify: '2k', // số lượng còn lại
    productCondition: 'New: 1000, Used: 350, Refurbished:650 ', // tình trạng sản phẩm
    warranty: '12 months', // bảo hành
  },
  {
    _id: '4444',
    ...
    description: 'Siếu cấp vip pro',
    image: './note-20-ultra.jpg',
    manufacturer: 'SAMSUNG', // hãng sản xuất
    series: 'SamSung Galaxy Note Series',
    releaseDate: '10/5/2023', // ngày sản xuất
    price: '800000000',
    OS: 'Android', // hệ điều hành,
    screenSize: '4.5 inches', //kích thước màn hình,
    screenType: 'AMOLED', //  loại màn hình
    cpu: 'SanpDragon', // vi xử lí
    ram: '12GB', //
    rom: '256GB', // bộ nhớ trong
    batteryCapacity: '5000mAh', // dung lượng pin
    mainCamera: '108MP', //camera chính
    ...
    dimensions: 'length: 160.7 mm, width: 77.6 mm, thickness: 7.85 mm, ',
    accessoriesIncluded: 'Charging cable, charger, headphones, phone case', // phụ kiện kèm theo
    numberOfReviews: ' 1.6k', // tổng số đánh giá
    rating: '4.5/5', // đánh giá
    stockQuantify: '1k', // số lượng còn lại
    productCondition: 'New: 400, Used: 450, Refurbished:50 ', // tình trạng sản phẩm
    warranty: '12 months', // bảo hành
  },
  {
    _id: '5555',
    ...
    dimensions: 'length: 160.7 mm, width: 77.6 mm, thickness: 7.85 mm, ',
    accessoriesIncluded: 'Charging cable, charger, headphones, phone case', // phụ kiện kèm theo
    numberOfReviews: ' 1.7k', // tổng số đánh giá
    rating: '4.5/5', // đánh giá
    stockQuantify: '2k', // số lượng còn lại
    productCondition: 'New: 1000, Used: 350, Refurbished:650 ', // tình trạng sản phẩm
    warranty: '12 months', // bảo hành
